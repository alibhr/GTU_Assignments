...
public class User {
    ...
    /**
     * Every User can login to system.
     * @param key checks whether the key is same with this User's password.
     * @return true if key is same with User's password.
     */
    public boolean login(String key){
        if(key==null)
            throw new NullPointerException();
        if( ! key.equals(this.getPassword())){

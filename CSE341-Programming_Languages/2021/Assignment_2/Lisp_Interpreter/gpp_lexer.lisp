...
(defvar tokens (list))
(defvar splited-line (list))

(defun evaluate-a-line (line)
  (when (and (= (char-code (char line 0)) 59 ) (= (char-code (char line 1)) 59 ))
    (push "COMMENT" tokens)
    (push ";;" splited-line)
    (return-from evaluate-a-line T))
